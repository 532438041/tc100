    ...
    var $target,
        BackDrop = (function () {
            var $backDrop,
                count = 0,
                create = function () {
                    $backDrop = $('<div class="modal-backdrop fade in"></div>').appendTo($target);
                };
        ...
        getTpl = function () {
            return ['<div class="modal fade" data-backdrop="false" data-show="false" data-keyboard="false">',
                ...
                '                <button class="close btn-cancel" type="button" data-dismiss="modal">×</button><h5 class="modal-title"></h5>',
                '            </div>',
        ...
        initModal = function (that, opts) {
        	$target = !!opts.content ? opts.content.parent() : $(document.body);
        ...
        createModal = function (that) {
            var $modal = that.$modal = $(getTpl()).appendTo($target);
    ...
    $.extend(ModalDialog.prototype, {
        ...
        setContent: (function () {
            ...
            return function (content) {
                ...
                !!content && typeof(content) === 'object' && content.removeClass("hidden");
