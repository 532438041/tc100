package com.java.common.geetest;
...
public class GeetestLib {
	...
	private String getFailPreProcessRes() {
		...
		return String.format("{\"success\":%s,\"gt\":\"%s\",\"challenge\":\"%s\"}", 0, this.captchaId, challenge);
	}
	...
	private String getSuccessPreProcessRes(String challenge) {
		...
		return String.format("{\"success\":%s,\"gt\":\"%s\",\"challenge\":\"%s\"}", 1, this.captchaId, challenge);
	}
	...
	public int failbackValidateRequest(String challenge, String validate, String seccode) {
		...
		gtlog(String.format("encode----challenge:%s--ans:%s,bg_idx:%s,grp_idx:%s", challenge, encodeAns, encodeFullBgImgIndex, encodeImgGrpIndex));
		...
		gtlog(String.format("decode----ans:%s,bg_idx:%s,grp_idx:%s", decodeAns, decodeFullBgImgIndex, decodeImgGrpIndex));
